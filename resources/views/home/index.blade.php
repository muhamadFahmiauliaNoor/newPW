...
@section('title', 'Selamat Datang di Kampus')

@section('content')
<div class="bg-green-300 p-12 rounded-lg shadow-lg">
    <h1 class="text-4xl font-extrabold text-white text-center">Selamat Datang di Kampus Anda</h1>
...
<div class="mt-12 bg-green-100 p-12 rounded-lg shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-xl">
            <img src="{{ $ukm->logo }}" alt="{{ $ukm->name }}" class="w-full h-40 object-cover rounded mb-4">
...
<div class="mt-12 bg-green-100 p-12 rounded-lg shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow hover:shadow-xl">
            <img src="{{ $facility->image }}" alt="{{ $facility->name }}" class="w-full h-40 object-cover rounded mb-4">
